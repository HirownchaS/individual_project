				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<div class="form_group">
							...
							<a href="basket.php"><input type="submit" name="submit" class="submit add_order" value="Add to Order" /></a>
	...
	<div class="inner_content">
		...
		<div class="contact">
			...
			<div class="left">
				...
				<h3>ABOUT US</h3>
				<p>This restaurant, is a business that prepares and serves food and drinks to customers.</p>
